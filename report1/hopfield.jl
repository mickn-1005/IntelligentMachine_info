...
function Hopfield_main()
    ...
    plot(noises,tfs2, label="2-mem",xlabel="noise ratio", ylabel="accuracy[%]")
    plot!(noises,tfs4, label="4-mem")
    plot!(noises,anti2, label="2-anti")
    plot!(noises,anti4, label="4-anti")
    savefig("out8.png")
end
